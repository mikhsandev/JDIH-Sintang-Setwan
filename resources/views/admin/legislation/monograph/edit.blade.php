                ...
                <div class="flex-1 order-2 order-lg-1">
                    ...
                    <div class="card card-body">
                        <div class="alert alert-info border-0">
                            Penjelasan dan pedoman tata cara penulisan metadata monografi dapat dilihat pada <a href="https://jdih.sintang.go.id/produk-hukum/peraturan-perundang-undangan/permenkumham/24804">Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen dan Informasi Hukum</a>.
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">Format penulisan: Huruf kapital hanya diawal judul, selebihnya huruf kecil. Contoh: Pengantar hukum adat Sintang.</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">Contoh: Sintang.</div>
                                    @error('place')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">Tempat fisik monografi disimpan. Contoh: Bagian Hukum Setwan Kabupaten Sintang.</div>
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
